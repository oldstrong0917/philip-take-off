        ...
        >
          ...
          >
            {imageUrl ? (
              ...
              <div className="w-full h-full bg-stone-100 flex flex-col items-center justify-center text-stone-500">
                <svg
                  className="w-12 h-12 mb-3 text-stone-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-sm font-sans">未附照片</p>
              </div>
            )}
          </div>
